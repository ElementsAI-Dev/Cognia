## Purpose
Define host-side MCP Apps behavior in Cognia, including extension negotiation, metadata preservation, widget rendering, bridge-mediated tool invocation, and graceful fallback.
