## Purpose
Define mandatory MCP Apps host security controls for Cognia, including iframe isolation, CSP/domain policy, bridge message validation, tool access control, and external navigation mediation.
