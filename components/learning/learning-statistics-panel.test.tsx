...
const mockSession: Partial<LearningSession> = {
  ...
  concepts: [
    { id: 'c1', name: 'useState', description: 'State hook', masteryStatus: 'mastered', masteryScore: 100, reviewCount: 5, correctAnswers: 5, totalAttempts: 5, relatedConceptIds: [] },
    { id: 'c2', name: 'useEffect', description: 'Effect hook', masteryStatus: 'learning', masteryScore: 70, reviewCount: 3, correctAnswers: 2, totalAttempts: 3, relatedConceptIds: [] },
    { id: 'c3', name: 'useCallback', description: 'Callback hook', masteryStatus: 'mastered', masteryScore: 90, reviewCount: 4, correctAnswers: 4, totalAttempts: 4, relatedConceptIds: [] },
  ],
};
...
describe('LearningStatisticsPanel', () => {
  ...
  describe('Edge Cases', () => {
    it('handles zero questions answered', () => {
      ...
      render(
        <LearningStatisticsPanel session={zeroSession as LearningSession} />,
        { wrapper }
      );
    ...
    it('handles zero time spent', () => {
      ...
      render(
        <LearningStatisticsPanel session={zeroTimeSession as LearningSession} />,
        { wrapper }
      );
  ...
  describe('Time Formatting', () => {
    ...
    it('formats hours correctly', () => {
      ...
      render(
        <LearningStatisticsPanel session={longSession as LearningSession} />,
        { wrapper }
      );
      // Time spent section should exist
      expect(screen.getByText('Time Spent')).toBeInTheDocument();
