...
jest.mock("./chat-widget-header", () => ({
  ChatWidgetHeader: ({ onClose, onSettings }: {
    onClose?: () => void;
    onSettings?: () => void;
  }) => (
...
jest.mock("./chat-widget-messages", () => ({
  ChatWidgetMessages: ({ messages, isLoading, error }: {
    messages: unknown[];
    isLoading: boolean;
    error: string | null;
  }) => (
...
jest.mock("./chat-widget-input", () => ({
  ChatWidgetInput: ({ value, onChange, onSubmit }: {
    value: string;
...
jest.mock("./chat-widget-settings", () => ({
  ChatWidgetSettings: ({ open, onOpenChange }: {
    open: boolean;
...
jest.mock("./chat-widget-suggestions", () => ({
  ChatWidgetSuggestions: ({ onSelect }: {
