...
import {
  Lightbulb, TrendingUp, Users, Calendar, Quote,
  Plus, RefreshCw, Sparkles, ExternalLink
} from 'lucide-react';
  ...
  const recommendations = useMemo(() => {
    ...
    const trendingPapers: RecommendedPaper[] = searchResults
      ...
      .map(paper => ({
        ...
        relevanceScore: (paper.citationCount || 0) / Math.max(1, new Date().getFullYear() - (paper.year || 2000)),
      }))
      .sort((a, b) => b.relevanceScore - a.relevanceScore)
      .slice(0, 10);
