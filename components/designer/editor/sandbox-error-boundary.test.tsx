...
function _ThrowSpecificError({ errorType }: { errorType: string }): React.ReactNode {
  switch (errorType) {
    case 'reference':
...
describe('SandboxErrorBoundary', () => {
  ...
  describe('error message parsing', () => {
    // Note: Error type parsing tests (reference, type, syntax, module, loop, hook)
    // require complex error boundary setup that is difficult to test reliably
    // with React 19's error handling changes
  });
});
