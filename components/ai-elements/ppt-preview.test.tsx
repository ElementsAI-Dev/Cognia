...
import { PPTPreview, type PPTPreviewProps } from './ppt-preview';
  ...
  describe('View Modes', () => {
    ...
    it('should show Marp markdown in outline view', async () => {
      ...
      if (outlineBtn) {
        ...
        const marpTab = screen.getByText('Marp Code');
        await userEvent.click(marpTab);
        
        // Should show marp content
  ...
  describe('Fullscreen', () => {
    it('should toggle fullscreen mode', async () => {
      ...
      if (fullscreenBtn) {
        ...
        // Card should have fullscreen classes
        const card = container.querySelector('.fixed.inset-0');
  ...
  describe('Export', () => {
    it('should trigger export when export option is clicked', async () => {
      ...
      if (exportBtn) {
        ...
        await waitFor(() => {
          const marpOption = screen.getByText(/Export as Marp/);
          if (marpOption) {
