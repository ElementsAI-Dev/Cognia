...
export const PlanHeader = ({ className, ...props }: PlanHeaderProps) => (
  <CardHeader
    className={cn('flex items-start justify-between', 'p-3 sm:p-4 pb-2 sm:pb-3', className)}
...
export const PlanFooter = ({ className, ...props }: PlanFooterProps & { className?: string }) => (
  <CardFooter data-slot="plan-footer" className={cn('p-3 sm:p-4 pt-0', className)} {...props} />
);
