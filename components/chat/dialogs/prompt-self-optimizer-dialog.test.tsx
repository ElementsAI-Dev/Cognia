...
// Mock prompt optimizer utilities
jest.mock('@/lib/ai/generation/prompt-self-optimizer', () => ({
  suggestBestPractices: jest.fn().mockResolvedValue([]),
  quickAnalyze: jest.fn().mockResolvedValue({ score: 80, suggestions: [] }),
  compareOptimization: jest.fn().mockResolvedValue({ improvements: [], regressions: [] }),
}));
