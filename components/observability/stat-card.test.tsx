...
describe('StatCard sizes', () => {
  it('should render compact size', () => {
    const { container } = render(
      <StatCard title="Test" value="100" size="compact" />
    );
  ...
  it('should render default size', () => {
    const { container } = render(
      <StatCard title="Test" value="100" size="default" />
    );
  ...
  it('should render large size', () => {
    const { container } = render(
      <StatCard title="Test" value="100" size="large" />
    );
...
describe('StatCard animations', () => {
  it('should have hover animation classes when animated is true', () => {
    const { container } = render(
      <StatCard title="Test" value="100" animated />
    );
