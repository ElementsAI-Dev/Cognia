...
describe('EfficiencyMetricsCard', () => {
  ...
  it('should display efficiency score badge', () => {
    ...
    expect(screen.getByText(/excellent|good|moderate|needs improvement/i)).toBeInTheDocument();
  });
  ...
  it('should handle high cost per K token (poor efficiency)', () => {
    ...
    expect(screen.getByText(/needs improvement|moderate/i)).toBeInTheDocument();
  });
