...
describe('EmptyState', () => {
  ...
  it('renders custom action', () => {
    render(<EmptyState title="No results" action={<button>Custom Action</button>} />);
  ...
  it('calls onClick when action clicked', () => {
    const onClick = jest.fn();
    render(<EmptyState title="No results" actions={[{ label: 'Add New', onClick }]} />);
  ...
  it('renders action with icon', () => {
    const { container } = render(
      <EmptyState title="No results" actions={[{ label: 'Add', onClick: jest.fn(), icon: Plus }]} />
    );
  ...
  it('applies compact mode', () => {
    const { container } = render(<EmptyState title="No results" compact />);
  ...
  it('applies custom icon className', () => {
    const { container } = render(
      <EmptyState
        title="No results"
        icon={<Search className="custom-icon" />}
