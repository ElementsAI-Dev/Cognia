...
describe('ExternalAgentPlan', () => {
  ...
  it('should render nothing when entries is empty', () => {
    const { container } = renderWithIntl(<ExternalAgentPlan entries={[]} />);
  ...
  it('should render plan title', () => {
    renderWithIntl(<ExternalAgentPlan entries={mockEntries} />);
  ...
  it('should highlight current step when specified', () => {
    renderWithIntl(<ExternalAgentPlan entries={mockEntries} currentStep={1} />);
  ...
  it('should render in compact mode when specified', () => {
    renderWithIntl(<ExternalAgentPlan entries={mockEntries} compact={true} />);
  ...
  it('should apply custom className', () => {
    renderWithIntl(<ExternalAgentPlan entries={mockEntries} className="custom-class" />);
  ...
  it('should calculate progress correctly', () => {
    ...
    renderWithIntl(<ExternalAgentPlan entries={allCompletedEntries} />);
  ...
  it('should handle skipped status entries', () => {
    ...
    renderWithIntl(<ExternalAgentPlan entries={entriesWithSkipped} />);
