...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/95 supports-[backdrop-filter]:bg-card/85 text-card-foreground backdrop-blur-sm flex flex-col gap-4 sm:gap-6 rounded-lg sm:rounded-xl border py-4 sm:py-6 shadow-sm",
        className
      )}
      {...props}
    />
