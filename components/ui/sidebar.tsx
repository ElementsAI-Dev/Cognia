...
export type SidebarImageFit = ComponentBackgroundFit;
export type SidebarImagePosition = BackgroundImagePosition;
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            'group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-0 w-full overflow-hidden h-full',
            className
          )}
          {...props}
        >
...
interface SidebarProps extends React.ComponentProps<'div'>, ComponentBackgroundProps {
  side?: 'left' | 'right';
