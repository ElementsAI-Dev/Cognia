...
import { MessageSquare, Thermometer, Hash, History, Sparkles, SlidersHorizontal, Shrink, Info } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <Tabs defaultValue="generation" className="w-full">
          <TabsList className="grid w-full grid-cols-3 h-9">
            <TabsTrigger value="generation" className="text-xs gap-1.5">
