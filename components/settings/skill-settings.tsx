        ...
        <Collapsible open={expanded} onOpenChange={setExpanded}>
          ...
          <CollapsibleContent className="mt-4 space-y-4">
            <div className="text-sm text-muted-foreground">
              <p><strong>Category:</strong> {CATEGORY_LABELS[skill.category]}</p>
              <p><strong>Source:</strong> {skill.source}</p>
              {skill.version && <p><strong>Version:</strong> {skill.version}</p>}
              {skill.usageCount !== undefined && (
                <p><strong>Used:</strong> {skill.usageCount} times</p>
              )}
            </div>
