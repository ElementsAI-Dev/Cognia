...
description: Create, structure, and publish self-contained Convex components. Use when building reusable Convex packages with isolated tables and functions, structuring component schemas and configurations, providing type-safe hooks for component consumers, publishing components to npm, or using multiple component instances in a single app. Covers convex.config.ts, defineComponent, and the full component lifecycle.
---
