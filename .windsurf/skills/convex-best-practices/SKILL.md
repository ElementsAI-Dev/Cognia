...
description: Guidelines for building production-ready Convex applications. Use when organizing Convex functions by domain, designing query patterns with indexes, validating arguments and return types, handling errors with ConvexError, avoiding write conflicts with OCC patterns, using TypeScript Id/Doc types, choosing between public and internal functions, or following the Zen of Convex design philosophy. Also covers @convex-dev/eslint-plugin setup.
---
