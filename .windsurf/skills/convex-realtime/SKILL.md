...
description: Build reactive applications with Convex real-time subscriptions. Use when implementing live-updating UI with useQuery, adding optimistic updates for instant feedback, building cursor-based pagination with usePaginatedQuery, implementing infinite scroll, handling conditional queries with "skip", or understanding Convex's automatic subscription and smart caching behavior.
---
