...
description: Quick security audit checklist for Convex applications. Use for rapid security review of authentication checks, function exposure (public vs internal), argument validation completeness, row-level access control, and environment variable handling. Lighter than convex-security-audit — use this for quick checklists, use security-audit for deep implementation patterns.
---
