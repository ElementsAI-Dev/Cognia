...
description: Define and validate Convex database schemas. Use when creating schema.ts with defineSchema/defineTable, configuring indexes (single, compound, search, vector), choosing validator types (v.string, v.id, v.union, v.optional, v.record, v.literal, v.array, v.object), designing discriminated unions for polymorphic data, planning index strategies for query patterns, or understanding optional vs nullable field semantics.
---
