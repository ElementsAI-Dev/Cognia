...
export function isExecutionSuccessful(result: KernelExecutionResult): boolean {
  return result.success && !result.error;
}

/** Helper to extract text output from execution result */
export function getTextOutput(result: KernelExecutionResult): string {
  if (result.stdout) {
...
export function getHtmlOutput(result: KernelExecutionResult): string | null {
...
export function getImageOutput(result: KernelExecutionResult): string | null {
