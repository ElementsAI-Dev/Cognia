...
interface CustomThemeState {
  ...
  // Actions
  addTheme: (theme: Omit<CustomSyntaxTheme, 'id' | 'isCustom' | 'createdAt' | 'updatedAt'>) => string;
  updateTheme: (id: string, updates: Partial<Omit<CustomSyntaxTheme, 'id' | 'isCustom' | 'createdAt'>>) => void;
 ...
 */
export function createDefaultThemeTemplate(name: string, basedOnDark: boolean = true): Omit<CustomSyntaxTheme, 'id' | 'isCustom' | 'createdAt' | 'updatedAt'> {
  return {
